...
exports.helpCmd = (socket,rl) => {
    ...
    log(socket, "   p|play - Jugar apreguntar aleatoriamente todos los quizzes.");
...
exports.creditsCmd = (socket,rl) =>{
    ...
    log(socket,'Carlos Cañete Pérez-Serrano','green');
    log(socket,'Jorge Sánchez Revuelta','green');
    rl.prompt();
};
